        ...
        <div className="bg-[#141414] rounded-2xl p-6 border border-[#2a2a2a]">
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-shrink-0">
                    <div className="w-32 h-32 rounded-full overflow-hidden bg-[#2a2a2a] border-4 border-[#da2128]">
                        {profile?.anhDaiDien ? (
                            <img
                ...
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-white mb-2">{profile?.hoTen || 'PT'}</h1>
